...
{
    /// <summary>
    /// MBankのDBAccessorクラスを定義します。
    /// </summary>
    public partial class BSMBankAccessor : CommonLogic
    {
        /// <summary>MBankのDao</summary>
        protected MBankDao Dao = null;
        ...
        /// <summary>DbContext</summary>
        public string TableDbName = "M_BANK"; 
        ...
        public BSMBankAccessor(ApplicationDbContext context) : base(context)
        {
            Dao = new MBankDao(context);
            Context = context;
        }
        #endregion
        ...
        public IList<MBank> Get()
        {
            return Query<MBank>("SELECT * FROM M_BANK ");
        }
        ...
        /// <returns>件数</returns>
        public Response MBankCUD(IList<MBank> datalist)
        {
        ...
        /// <returns>件数</returns>
        public virtual Response MBankCUD(MBank data)
        {
            Response _Response = new Response()
            {
                Status = false,
        ...
        /// <param name="dataList">更新用データリスト</param>
        /// <returns>件数</returns>
        public Response MBankBulkCUD(IList<MBank> datalist)
        {
            Response _Response = new Response()
            {
                Status = false,
            ...
            // インサート用データ
            IList<MBank> inserList = new List<MBank>();
            // アップデート用データ
            IList<MBank> updateList = new List<MBank>();
            // デリート用データ
            IList<MBank> deleteList = new List<MBank>();
        ...
        public MBank Find(MBank data)
        {
            var rec = Dao.Find(data.Id);
            if (rec == null)
            {
                 OriginalException.ExclusiveException("MBank Key=" + ((long)data.Id).ToString());
            }
        ...
        public int InsetdataList(IList<MBank> inserList)
        {
            int cnt = 0;
            var sql = string.Empty;
            IList<MBank> dataList = new List<MBank>();
        ...
        /// <returns>更新件数</returns>
        public int UpdateList(IList<MBank> UpdateList)
        {
            int cnt = 0;
            var sql = string.Empty;
            IList<MBank> dataList = new List<MBank>();
        ...
        public string GetInsertSql(IList<MBank> inserList)
        {
        ...
        /// <returns>SQL</returns>
        public string EditInsertSql(MBank entity)
        {
            var sql = new StringBuilder();
            ...
            sql.Append(" " + GenericUtil.StringToString(entity.BankName) + ", ");
            sql.Append(" " + GenericUtil.StringToString(entity.BankNameKana) + ", ");
            sql.Append(" " + GenericUtil.StringToString(entity.BranchName) + ", ");
            sql.Append(" " + GenericUtil.StringToString(entity.BranchNameKana) + ", ");
        ...
        /// <returns>SQL文</returns>
        public string GetUpdateSql(IList<MBank> updateList)
        {
            var now = DateTime.Now;
            var strSql = string.Empty;
        ...
        /// <param name="entity">エンティティ</param>
        /// <returns>SQL</returns>
        public string EditUpdateSql(MBank entity)
        {
            var sql = new StringBuilder();
            ...
            sql.Append(",   BANK_NAME  = " + GenericUtil.StringToString(entity.BankName));
            sql.Append(",   BANK_NAME_KANA  = " + GenericUtil.StringToString(entity.BankNameKana));
            sql.Append(",   BRANCH_NAME  = " + GenericUtil.StringToString(entity.BranchName));
            sql.Append(",   BRANCH_NAME_KANA  = " + GenericUtil.StringToString(entity.BranchNameKana));
        ...
        /// <returns>SQL</returns>
        public string CreateCSV(IList<MBank> dataList, bool header = true)
        {
            ...
            if (header)
            {
                ...
                csv.Append("BANK_CD" + "\t");
                csv.Append("SITEN_CD" + "\t");
                csv.Append("BANK_NAME" + "\t");
                csv.Append("BANK_NAME_KANA" + "\t");
                csv.Append("BRANCH_NAME" + "\t");
                csv.Append("BRANCH_NAME_KANA" + "\t");
            ...
            foreach (var data in dataList)
            {
                ...
                csv.Append(data.BankName + "\t");
                csv.Append(data.BankNameKana + "\t");
                csv.Append(data.BranchName + "\t");
                csv.Append(data.BranchNameKana + "\t");
        ...
        public virtual void DefaultSet(MBank data)
        {
        }
