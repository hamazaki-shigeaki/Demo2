...
{
    /// <summary>
    /// TOcrMotoのDBAccessorクラスを定義します。
    /// </summary>
    public partial class BSTOcrMotoAccessor : CommonLogic
    {
        /// <summary>TOcrMotoのDao</summary>
        protected TOcrMotoDao Dao = null;
        ...
        /// <summary>DbContext</summary>
        public string TableDbName = "T_OCR_MOTO"; 
        ...
        public BSTOcrMotoAccessor(ApplicationDbContext context) : base(context)
        {
            Dao = new TOcrMotoDao(context);
            Context = context;
        }
        #endregion
        ...
        public IList<TOcrMoto> Get()
        {
            return Query<TOcrMoto>("SELECT * FROM T_OCR_MOTO ");
        }
        ...
        /// <returns>件数</returns>
        public Response TOcrMotoCUD(IList<TOcrMoto> datalist)
        {
        ...
        /// <returns>件数</returns>
        public virtual Response TOcrMotoCUD(TOcrMoto data)
        {
            Response _Response = new Response()
            {
                Status = false,
        ...
        /// <param name="dataList">更新用データリスト</param>
        /// <returns>件数</returns>
        public Response TOcrMotoBulkCUD(IList<TOcrMoto> datalist)
        {
            Response _Response = new Response()
            {
                Status = false,
            ...
            // インサート用データ
            IList<TOcrMoto> inserList = new List<TOcrMoto>();
            // アップデート用データ
            IList<TOcrMoto> updateList = new List<TOcrMoto>();
            // デリート用データ
            IList<TOcrMoto> deleteList = new List<TOcrMoto>();
        ...
        public TOcrMoto Find(TOcrMoto data)
        {
            var rec = Dao.Find(data.Id);
            if (rec == null)
            {
                 OriginalException.ExclusiveException("TOcrMoto Key=" + ((long)data.Id).ToString());
            }
        ...
        public int InsetdataList(IList<TOcrMoto> inserList)
        {
            int cnt = 0;
            var sql = string.Empty;
            IList<TOcrMoto> dataList = new List<TOcrMoto>();
        ...
        /// <returns>更新件数</returns>
        public int UpdateList(IList<TOcrMoto> UpdateList)
        {
            int cnt = 0;
            var sql = string.Empty;
            IList<TOcrMoto> dataList = new List<TOcrMoto>();
        ...
        public string GetInsertSql(IList<TOcrMoto> inserList)
        {
        ...
        /// <returns>SQL</returns>
        public string EditInsertSql(TOcrMoto entity)
        {
            var sql = new StringBuilder();
        ...
        /// <returns>SQL文</returns>
        public string GetUpdateSql(IList<TOcrMoto> updateList)
        {
            var now = DateTime.Now;
            var strSql = string.Empty;
        ...
        /// <param name="entity">エンティティ</param>
        /// <returns>SQL</returns>
        public string EditUpdateSql(TOcrMoto entity)
        {
            var sql = new StringBuilder();
        ...
        /// <returns>SQL</returns>
        public string CreateCSV(IList<TOcrMoto> dataList, bool header = true)
        {
        ...
        public virtual void DefaultSet(TOcrMoto data)
        {
        }
