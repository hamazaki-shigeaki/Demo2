...
{
    /// <summary>
    /// MDocumentのDBAccessorクラスを定義します。
    /// </summary>
    public partial class BSMDocumentAccessor : CommonLogic
    {
        /// <summary>MDocumentのDao</summary>
        protected MDocumentDao Dao = null;
        ...
        /// <summary>DbContext</summary>
        public string TableDbName = "M_DOCUMENT"; 
        ...
        public BSMDocumentAccessor(ApplicationDbContext context) : base(context)
        {
            Dao = new MDocumentDao(context);
            Context = context;
        }
        #endregion
        ...
        public IList<MDocument> Get()
        {
            return Query<MDocument>("SELECT * FROM M_DOCUMENT ");
        }
        ...
        /// <returns>件数</returns>
        public Response MDocumentCUD(IList<MDocument> datalist)
        {
        ...
        /// <returns>件数</returns>
        public virtual Response MDocumentCUD(MDocument data)
        {
            Response _Response = new Response()
            {
                Status = false,
        ...
        /// <param name="dataList">更新用データリスト</param>
        /// <returns>件数</returns>
        public Response MDocumentBulkCUD(IList<MDocument> datalist)
        {
            Response _Response = new Response()
            {
                Status = false,
            ...
            // インサート用データ
            IList<MDocument> inserList = new List<MDocument>();
            // アップデート用データ
            IList<MDocument> updateList = new List<MDocument>();
            // デリート用データ
            IList<MDocument> deleteList = new List<MDocument>();
        ...
        public MDocument Find(MDocument data)
        {
            var rec = Dao.Find(data.Id);
            if (rec == null)
            {
                 OriginalException.ExclusiveException("MDocument Key=" + ((long)data.Id).ToString());
            }
        ...
        public int InsetdataList(IList<MDocument> inserList)
        {
            int cnt = 0;
            var sql = string.Empty;
            IList<MDocument> dataList = new List<MDocument>();
        ...
        /// <returns>更新件数</returns>
        public int UpdateList(IList<MDocument> UpdateList)
        {
            int cnt = 0;
            var sql = string.Empty;
            IList<MDocument> dataList = new List<MDocument>();
        ...
        public string GetInsertSql(IList<MDocument> inserList)
        {
        ...
        /// <returns>SQL</returns>
        public string EditInsertSql(MDocument entity)
        {
            var sql = new StringBuilder();
            sql.Append(" " + GenericUtil.LongToString(entity.Id) + ", ");
            sql.Append(" " + GenericUtil.StringToString(entity.DocumentNo) + ", ");
            sql.Append(" " + GenericUtil.StringToString(entity.SuitNo) + ", ");
            sql.Append(" " + GenericUtil.StringToString(entity.DocClassification) + ", ");
            sql.Append(" " + GenericUtil.StringToString(entity.DocName) + ", ");
            sql.Append(" " + GenericUtil.StringToString(entity.Contents) + ", ");
            sql.Append(" " + GenericUtil.StringToString(entity.FolderName) + ", ");
            sql.Append(" " + GenericUtil.StringToString(entity.FileName) + ", ");
        ...
        /// <returns>SQL文</returns>
        public string GetUpdateSql(IList<MDocument> updateList)
        {
            var now = DateTime.Now;
            var strSql = string.Empty;
        ...
        /// <param name="entity">エンティティ</param>
        /// <returns>SQL</returns>
        public string EditUpdateSql(MDocument entity)
        {
            var sql = new StringBuilder();
            sql.Append("UPDATE M_DOCUMENT");
            sql.Append(" SET");
            sql.Append("   DOCUMENT_NO  = " + GenericUtil.StringToString(entity.DocumentNo));
            sql.Append(",   SUIT_NO  = " + GenericUtil.StringToString(entity.SuitNo));
            sql.Append(",   DOC_CLASSIFICATION  = " + GenericUtil.StringToString(entity.DocClassification));
            sql.Append(",   DOC_NAME  = " + GenericUtil.StringToString(entity.DocName));
            sql.Append(",   CONTENTS  = " + GenericUtil.StringToString(entity.Contents));
            sql.Append(",   FOLDER_NAME  = " + GenericUtil.StringToString(entity.FolderName));
            sql.Append(",   FILE_NAME  = " + GenericUtil.StringToString(entity.FileName));
        ...
        /// <returns>SQL</returns>
        public string CreateCSV(IList<MDocument> dataList, bool header = true)
        {
            var csv = new StringBuilder();
            if (header)
            {
                csv.Append("ID" + "\t");
                csv.Append("DOCUMENT_NO" + "\t");
                csv.Append("SUIT_NO" + "\t");
                csv.Append("DOC_CLASSIFICATION" + "\t");
                csv.Append("DOC_NAME" + "\t");
                csv.Append("CONTENTS" + "\t");
                csv.Append("FOLDER_NAME" + "\t");
            ...
            foreach (var data in dataList)
            {
                ...
                csv.Append(data.DocumentNo + "\t");
                csv.Append(data.SuitNo + "\t");
                csv.Append(data.DocClassification + "\t");
                csv.Append(data.DocName + "\t");
                csv.Append(data.Contents + "\t");
                csv.Append(data.FolderName + "\t");
                csv.Append(data.FileName + "\t");
        ...
        public virtual void DefaultSet(MDocument data)
        {
        }
